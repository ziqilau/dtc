...
extern gsl_rng * g_random_number;
...
{
    return gsl_ran_gamma_mt(g_random_number, a, b);
}

double rbeta(double a, double b)
{
    return gsl_ran_beta(g_random_number, a, b);
}

unsigned int rbernoulli(double p)
{
    return gsl_ran_bernoulli(g_random_number, p);
}

double runiform()
{
    return gsl_rng_uniform_pos(g_random_number);
}

void rshuffle(void* base, size_t n, size_t size)
{
    gsl_ran_shuffle(g_random_number, base, n, size);
}

unsigned long int runiform_int(unsigned long int n)
{
    return gsl_rng_uniform_int(g_random_number, n);
}
